  ...
  actions: {
    ...
    async findActiveConfig() {
      try {
        ...
        this.activeconfig = Object.assign({}, ...rsp.data)
      } catch (ex) {
    ...
    async findConfigReadList() {
      try {
        ...
        this.configReadlist = configObject
      } catch (ex) {
        $msg.alert('Store Error', ex, 'danger')
      }
    },
