          ...
          <div class="box box-solid">
            <div class="box-body">
              <div class="row">
                ...
                <div class="col-md-7 col-xs-12">
                  <div class="gm-chart-card">
                    ...
                    <v-chart class="piechart" autoresize :option="pieChartOption1" style="width: 100% !important; height: 460px;" />
                  </div>
                </div>
                ...
                <div class="col-md-5 col-xs-12">
                  <div class="gm-chart-card">
                    ...
                    <v-chart class="piechart" autoresize :option="pieChartOption2" style="width: 100% !important; height: 460px;" />
                  </div>
                </div>
              </div>
              ...
              <div v-if="!xt.isEmpty(formData.pre_event)" class="gm-chart-card gm-chart-card--bar">
                ...
                <v-chart ref="chart4" id="chart4" class="barchart" autoresize style="width: 100% !important; height: 360px;" :option="barChartOption" />
              </div>
            </div>
          </div>
    ...
    methods: {
     ...
     //   color: rsp.status.color,
      ...
      async loadByProject(p) {
       ...
       // color: rsp.ll_color.color,
        ...
        myChart.on('click', async  (params) => { 
          ...
          this.tmp.status = params.keyData
          this.tmp.item_type = params.slcData
          await $xt.sleep(800)
      ...
      async clickbydetail(status, itemType) {
        ...
        this.datalist_byproject = rsp.data;
