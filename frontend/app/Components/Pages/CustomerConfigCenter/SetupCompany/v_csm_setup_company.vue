  ...
  export default {
    ...
    methods: {
      ...
      async onLoadToken() {
        ...
        this.ref_cus_code = ref_cus_code;
        ...
        try {
            ...
            this.servicePath = obj2.ServicePath || "";
        } catch {
            sessionStorage.removeItem(kSession);
        }
      },
      ...
      //   }
      //   else {
      //     this.displayNoProcess = this.noProcess
      //   }
      // },
      appendRow(keyword) {
        switch (keyword) {
      ...
      async addInfoComponent(e, keyword) {
        switch (keyword) {
          case 'company':
            this.maincode = e.maincode
            this.mainname = e.mainname
          ...
          case 'account':
            this.onTable.datacode = e.ac_code
            this.onTable.dataname = e.ac_des
            break
        }
      },
      autoChangeAddress(keyword, control = '1') {
        switch (keyword) {
          ...
          case 'EN':
            ...
            this.mainCompany.engaddr1 = engaddr1
            this.mainCompany.engaddr2 = engaddr2
            break
        }
      },
