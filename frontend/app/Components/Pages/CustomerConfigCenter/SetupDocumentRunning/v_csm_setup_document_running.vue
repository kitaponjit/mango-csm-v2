  ...
  export default {
    ...
    methods: {
      ...
      async openFormatRunning(x) {
        this.viewRun_h = x
        this.formcode = x.formcode
        this.widthRunno = x.format_width
      ...
      setText(x) {
        x.format_len = x.text_a.length
      },
      setWidth(x) {
        let type = x.format_ty
        x.format_len = ['B', 'C'].includes(type) ? 8 : ['D', 'E'].includes(type)
