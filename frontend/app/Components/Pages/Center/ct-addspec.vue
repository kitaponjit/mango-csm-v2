...
export default {
  ...
  methods: {
    ...
    toggleSelection(item, idx) {
      this.displayData[idx].checked = !item.checked == "Y" ? "Y" : "N"
      this.selectedItems = this.displayData.filter(x => x.checked == "Y")
    },
    sendSelectedItems() {
    ...
    selectItem(_, item) {
      ...
      this.datalist[findIndex].checked = item.checked
      this.selectedItems = this.datalist.filter(x => x.checked == "Y")
      this.selectAllChecked = this.datalist.every(x => x.checked == "Y") ? "Y" : "N"
      this.pageChange(this.pageNumber)
    },
    selectAll() {
