  ...
  let cpn = {
    ...
    methods: {
      ...
      pageChange1(pn) {
        ...
        this.display_item = $linq(this.data_item).skip(startIndex).take(paging1.getItemsPerPage()).toArray();
      ...
      setItem(x) {
        ...
        this.show_area.loccode = x.loccode;
        this.show_area.locname = x.locname;
        this.loadItemArea();
      },
      addItem() {
        if (this.isMaterial()) {
      ...
      async readArea(loccode) {
        ...
        let rsp = await $xt.getServer(act);
        this.area.loccode = rsp.data.loccode;
        this.area.locname = rsp.data.locname;
        this.area.active = rsp.data.active;
        this.area.maincode = rsp.data.maincode;
        this.setEditArea();
      ...
      sendComponent(e, type) {
        switch (type) {
          case "project":
            this.area.pre_event = e.pre_event;
            this.area.pre_event2 = e.pre_event2;
            this.area.pre_des = e.pre_des;
