    ...
    methods: {
      ...
      async uploadTemplate(f) {
        ...
        try {
          ...
          this.$set(this, 'dataDefault', rsp.data.data)
          this.$set(this.file, 'pathto', rsp.data.filepath)
          this.$set(this.file, 'filename', rsp.data.filename)
      ...
      initTable() {
        ...
        this.$set(this, 'columnDefs', columnDefs)
      },
      refreshGridData() {
