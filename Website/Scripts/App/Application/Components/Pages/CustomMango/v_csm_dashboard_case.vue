    ...
    methods: {
      ...
      async load_data() {
        try {
          ...
          this.$set(this, 'allData', rsps.data || []);
          this.$set(this, 'data_wait', rsps.data.waitingDev || []);
          this.$set(this, 'data_waitIt', rsps.data.waitingIt || []);
          this.$set(this, 'data_inprogress', rsps.data.inProgress || []);
          this.$set(this, 'data_review', pendingList);
          this.$set(this, 'data_reject', rsps.data.reject || []);
