...
<script type="text/javascript">
  ...
  export default {
    ...
    methods: {
      ...
      selectCustomer(item) {
        this.$set(this.data, 'customer_name', item.customer_name);
        this.$set(this.data, 'customer_code', item.customer_code);
        this.$set(this.data, 'pre_event', item.pre_event);
      ...
      clearCustomer() {
        this.$set(this.data, 'customer_name', '');
        this.$set(this.data, 'customer_code', '');
         this.$set(this.data, 'pre_event', '');
      },
    },
    mounted() {
      page = this.$refs.page
