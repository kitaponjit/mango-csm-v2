    ...
    methods: {
      async loadRetrieve(customer_code, pre_event) {
        ...
        if (rsp.data) {
          ...
          this.$set(this, 'attachFile', rsp.f);
          this.$set(this.formData, 'proj_name', rsp.data.proj_name);
        ...
        if (rsp.ar_cust != null) {
          ...
          this.$set(this.formData, 'tax_id', rsp.ar_cust.tax_id);
          this.$set(this.formData, 'card_id', rsp.ar_cust.card_id);
          this.$set(this.formData, 'address1', rsp.ar_cust.address1);
          this.$set(this.formData, 'address2', rsp.ar_cust.address2);
          this.$set(this.formData, 'address3', rsp.ar_cust.address3);
          this.$set(this.formData, 'contact', rsp.ar_cust.contact);
          this.$set(this.formData, 'salename', rsp.ar_cust.salename);

          this.$set(this.formData, 'userid', rsp.ar_cust.userid);
          this.$set(this.formData, 'userpass', rsp.ar_cust.userpass);
