  ...
  let home = {
    ...
    methods: {
      ...
      selectItem(item) {
        ...
        this.$set(this.datalistCopy[findIndex], "checked", item.checked)
        this.$set(this, "selectedItems", this.datalistCopy.filter(x => x.checked == "Y"))
        this.$set(this, "selectAllChecked", this.datalistCopy.every(x => x.checked == "Y") ? "Y" : "N")
        this.$set(this, "listJobNo", [])
      ...
      async selectCopyItem(e) {
        ...
        // อัพเดท listJobNo
        this.$set(this, 'listJobNo', this.selectedItems.map(x => x.job_no));
      ...
      async usercsm() {
        ...
        this.$set(this, 'user_config', resp.data.data_rows)
      },
      is_csm_all() {
    ...
    async mounted() {
      ...
      this.$set(this.retrieveSearch, 'serv_code', 'all_search')
