        ...
        <div class="ed">
          ...
          <section class="ed-panels">
            <article class="ed-panel">
              ...
              <v-chart v-if="grand.total" ref="chartMix" :autoResize="true" style="width:100%;height:310px;" :option="mixOption" />
            ...
            <article class="ed-panel ed-panel--wide">
              ...
              <v-chart v-if="grand.total" ref="chartRank" :autoResize="true" style="width:100%;height:310px;" :option="rankOption" />
              <div v-else class="ed-void"><i class="fas fa-inbox"></i> ไม่มีข้อมูลในปีนี้</div>
            </article>
          </section>
...
<script>
  ...
  let cpn = {
    ...
    methods: {
      ...
      pickYear(y) {
        this.$set(this.retrieveSearch, 'year', y)
        this.yearOpen = false
        this.loadRetrieve()
      },
      closeYear() {
