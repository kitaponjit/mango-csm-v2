      ...
      sendComponent(e, keyword) {
        switch (keyword) {
          case 'project':
            ...
            this.$set(this.headerData, "project_name", e.pre_des);
      ...
      resetData(type) {
        switch (type) {
          case 'project':
            ...
            this.$set(this.headerData, "pre_event", '');
            this.$set(this.headerData, "pre_event2", '');
            this.$set(this.headerData, "pre_des", '');
            this.$set(this.headerData, "pre_event_unit", '');
            this.$set(this.headerData, "pre_des_unit", '');
          ...
          case 'phase':
            ...
            this.$set(this.headerData, "project_name", this.headerData.pre_des);
            // ล้าง extraCond เฉพาะ pre_event (โครงการย่อย)
            this.extraCond.pre_event.value = null;
            this.$set(this.extraCond, "pre_event", {
              type: 'string',
              value: null
            });
            break;
