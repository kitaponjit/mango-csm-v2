  ...
  let cpn = {
    ...
    async saveClick2() {
      ...
      async delFile(itemno, maincode) {
        ...
        this.$set(this, 'attachmentData', $linq(this.attachmentData).where(x => !(x.itemno == itemno && x.maincode == maincode)).toArray())
      },
      attachFileTab() {
        let d = []
      ...
      async readImg() {
        try {
          ...
          this.$set(this, 'img_bg', resp.data.img || []);
        } catch (ex) {
          $msg.alert(``, ex.toString(), `danger`);
        }
      },
      ...
      async delFileCSM(itemno, maincode) {
        ...
        this.$set(this, 'attachmentDataCSM', $linq(this.attachmentDataCSM).where(x => !(x.itemno == itemno && x.maincode == maincode)).toArray())
      },
      attachFileTabCSM() {
        let d = []
      ...
      async readImgCSM() {
        try {
          ...
          let resp = await $xt.getServer(act);
          this.$set(this, 'img_bg_csm', resp.data.img || []);
        } catch (ex) {
          $msg.alert(``, ex.toString(), `danger`);
        }
      },
