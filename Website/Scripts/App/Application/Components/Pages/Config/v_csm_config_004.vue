...
let cpn = {
        ...
        datesSet: () => {
          ...
          if (!this.dayButtonsByYear[year]) {
            const normalHolidays = this.holidayList
              ...
              .map(h => h.date);
            this.$set(this.dayButtonsByYear, year, this.buildDayButtons(year, normalHolidays));
          }
        },
  ...
  methods: {
    ...
    recalcButtonsForYear(year) {
      ...
      this.$set(this.dayButtonsByYear, year, updated);
    },
    ...
    async loadData() {
      try {
        ...
        this.$set(this.dayButtonsByYear, currentYear, this.buildDayButtons(currentYear, normalHolidays));
    ...
    toggleDay(day) {
      ...
      if (!this.dayButtonsByYear[currentYear]) {
        this.$set(this.dayButtonsByYear, currentYear, this.defaultDayButtons());
      }
      ...
      this.$set(this.dayButtonsByYear, currentYear, [...currentButtons]);
