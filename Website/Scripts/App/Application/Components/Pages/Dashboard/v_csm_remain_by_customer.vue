        ...
        <section class="content rc-wrap">
          ...
          <div class="rc-grid2">
            <div class="rc-panel">
              ...
              <div class="rc-chart">
                <v-chart ref="chart1" id="chart_remain" :autoResize="true" style="width:100%!important;height:360px;" :option="barChartOption" />
              </div>
            </div>
            <div class="rc-panel">
              <div class="rc-panel__head">
              ...
              <div class="rc-chart">
                <v-chart ref="chart2" :autoResize="true" style="width:100%!important;height:360px;" :option="donutOption" />
              </div>
            </div>
          </div>
          ...
          <div class="rc-panel" v-if="workerWorkload.length">
            ...
            <div class="rc-chart">
              <v-chart ref="chartWorker" :autoResize="true" style="width:100%!important;height:400px;" :option="workerChartOption" />
            </div>
          </div>
          ...
          <div class="rc-panel" v-if="is_mango && testerTestload.length">
            ...
            <div class="rc-chart">
              <v-chart ref="chartTester" :autoResize="true" style="width:100%!important;height:400px;" :option="testerChartOption" />
            </div>
          </div>
  ...
  let cpn = {
    ...
    methods: {
      ...
      async loadChart() {
        ...
        this.$set(this, "statusColorMap", colorMap);
        this.$set(this, "statusCodeMap", codeMap);
        this.$set(this, "services", rsp.services || []);
        this.$set(this, "serviceGroups", rsp.serviceGroups || []);
        this.$set(this, "priorities", rsp.priorities || []);
        this.$set(this, "years", rsp.years || []);
        this.$set(this, "workers", rsp.workers || []);
        this.$set(this, "requesters", rsp.requesters || []);
        this.$set(this, "teamWorkersList", (rsp.team_wo || []).map(t => ({ team_code: t.code_tm, team_name: t.name_tm })));
        this.$set(this, "teamRequestersList", (rsp.team_req || []).map(t => ({ team_code: t.code_tm, team_name: t.name_tm })));
        this.$set(this, "testerQcList", rsp.tester_qc || []);
        this.$set(this, "statusApprList", rsp.status_appr || []);
        this.$set(this, "modules", rsp.module_ || []);
        this.$set(this, "rows", rsp.rows || []);
      ...
      clickByStatus(statusName) {
        ...
        this.$set(this, "selectedStatus", statusName);
        this.statusSearch = "";
      ...
      clickByWorker(workerName) {
        ...
        this.$set(this, "selectedWorker", workerName);
        this.$set(this, "selectedWorkerStatus", "");
        this.statusSearch = "";
        this.$refs.modalByStatus.openModal();
        this.$nextTick(() => this.initTableStatus());
      },
      clickByWorkerStatus(workerName, statusName) {
        ...
        this.modalMode = "worker";
        this.$set(this, "selectedWorker", workerName);
        this.$set(this, "selectedWorkerStatus", statusName || "");
        this.statusSearch = "";
        this.$refs.modalByStatus.openModal();
        this.$nextTick(() => this.initTableStatus());
      },
      clickByTesterStatus(testerName, statusName) {
        ...
        this.$set(this, "selectedTester", testerName);
        this.$set(this, "selectedTesterStatus", statusName || "");
        this.statusSearch = "";
        this.$refs.modalByStatus.openModal();
        this.$nextTick(() => this.initTableStatus());
      },
      ...
      async clickAllCustomers() {
        this.$set(this, "selectedCustomer", { customer_name: this.ui.csm_remain_all_customers, customer_code: "" });
      ...
      async loadDetail() {
        ...
        let rsp = await $xt.getServer(act);
        this.$set(this, "detailList", rsp.data || []);
        let ii = 1;
   ...
   async   loadData_Ai()
      {
        ...
        try {
          ...
          let rsp = await $xt.getServer(act);
          this.$set(this, "listData_forAI", rsp.dataList || []);
   ...
   async mounted() {
      ...
      this.$root.$on('AiChatChunk', (data) => {
        if (this.aiStreamIdx < 0) {
          ...
          if (msg) this.$set(this.chatMessages, this.aiStreamIdx, { ...msg, content: msg.content + (data.chunk || '') });
        }
        this.$nextTick(() => this.scrollChatToBottom());
      });
      this.$root.$on('AiChatDone', (data) => {
        ...
        if (this.aiStreamIdx >= 0) {
          const msg = this.chatMessages[this.aiStreamIdx];
          this.$set(this.chatMessages, this.aiStreamIdx, { role: 'assistant', content: msg ? msg.content : '', tokens });
        } else {
      ...
      this.$root.$on('AiChatError', (data) => {
        if (this.aiStreamIdx >= 0) {
          this.$set(this.chatMessages, this.aiStreamIdx, { role: 'assistant', content: '⚠️ ' + (data.error || this.ui.erp_error) });
        } else {
