  ...
  let cpn = {
    ...
    methods: {
      async loadFilterOptions() {
        ...
        this.$set(this, "customersList", rsp.customers || []);
        this.$set(this, "projectsList", rsp.projects || []);
        this.$set(this, "departmentsList", rsp.departments || []);
        this.$set(this, "statusesList", rsp.statuses || []);
        ...
        this.$set(this, "approveStatusList", rsp.approve_status || []);
      },
      buildFilterParams() {
        let f = this.filter;
      ...
      async loadData() {
        try {
          ...
          let d = rsp.data || {};
          this.$set(this, "reportRows", d.requesters || []);
          this.$set(this, "reportColumns", d.columns || []);
          this.$set(this, "reportGrand", d.grand_total || {});
          this.$set(this, "reportSummary", d.summary || {});
          this.queried = true;
      ...
      async openDetail(empno, name) {
        ...
        try {
          ...
          let d = rsp.data || {};
          this.$set(this, "detailRows", d.rows || []);
          this.$nextTick(() => {
