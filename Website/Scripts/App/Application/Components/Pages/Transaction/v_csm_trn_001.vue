    ...
    export default {
      ...
      methods: {
         ...
         console.log('test--q',q)
          if (q.refitemno_war != null) {
            ...
            if (matchedItem2 || matchedItem) {
              ...
              this.$set(this, 'warCheck', selectedItem);
            }
          }
          else {
            this.warCheck = null
          ...
          if (this.isMango) {
            ...
            this.$set(
              this,
              'list_emp_sa_mg',
              Array.isArray(saArray) && saArray.length
        ...
        async loadData(job_no) {
         page.loadingBox.show()
          ...
          this.$set(this, 'detailDataCount', _detailCount)
          this.$set(this, 'isRejectCount', _rejectCount)
          this.$set(this, 'detailComplete', _complete)
          this.$set(this, 'testerApproveCount', _tApproveCount)
          this.$set(this, 'testerApproveWait', _tApproveWait)
          this.$set(this, 'testerApproveReject', _tApproveReject)
          this.$set(this, 'prapproveDataAccept', _ppAccept)
          this.$set(this, 'prapproveDataReject', _ppReject)
          this.$set(this, 'isNewApprove', _hasNewApprove)
          this.$set(this, 'storeMapLocation', resp.data.map_location || {})
          this.$set(this, 'allWorkers', resp.data.refW)
          this.$set(this, 'receivedWorkers', resp.data.refW)
          ...
          this.detailData.forEach((x, idx) => {
           ...
           var isBugTester = this.send_test_bug.some(s => s.code_s_bug === x.item_type) && this.isMango && this.emp_is_software_tester()
            ...
            this.$set(x, 'sendback_round', x.status == 'B' ? $xt.int(x.count_tester_sendback) : $xt.int(x.count_tester_sendback) + 1)
          ...
          if (['Y'].includes(this.formData.job_status)) {
            ...
            if (resp.data.qc.length > 0) {
              this.$set(this.$refs.document_details, 'qc_form_code', $linq(resp.data.qc).select(x => x.qaform).firstOrDefault())
              ...
              this.$set(this.$refs.document_details, 'answerData', resp.data.qc)
        ...
        async showCommentExt(job_no, ref_docno) {
          ...
          try {
            ...
            this.$set(this,'data_',resp.data.commentData||[])
          } catch (error) {
        ...
        setEditCommentExt(x,edit) {
          if (edit == true) {
          this.$set(this, 'editExt', true)
            x.old_desc = x.detail_c
            this.$set(x, 'editExt', true)
          }
          else {
            this.$set(this, 'editExt', false)
            x.detail_c = x.old_desc
            this.$set(x, 'editExt', false)
          }
        },
        ...
        async sendComponent(e, type) {
          switch (type) {
            ...
            case 'cm_customer':
              ...
              this.$set(this.formData, 'cust_type_name', e.cust_type_name)
            ...
            case 'emp':
              switch (this.empType) {
                ...
                case 'change_worker_d':
                  ...
                  this.$set(arr2, 'assign_empno', e.empno)
                  this.$set(arr2, 'assign_empno_name', e.empfullname)
                  break
              }
              break
            case 'form':
            ...
            case 'job-detail':
              ...
              this.$set(this.formData, 'jobcode', e.jobcode)
              this.$set(this.formData, 'jobname', e.jobname)
              break
          }
        },
        ...
        async loadContactData(customer_code) {
          ...
          this.$set(this.contactData, 'header', rsp.data.header)
          this.$set(this.contactData, 'detail', rsp.data.detail)
        },
        async setContractData(customer_code) {
          ...
          this.$set(this.formData, 'cust_contact_name', detail ? detail.cust_contact_name : '')
          this.$set(this.formData, 'cust_contact_phone', detail ? detail.cust_contact_phone : '')
          this.$set(this.formData, 'cust_contact_email', detail ? detail.cust_contact_email : '')
        },
        async setUpdateSW(cuscode) {
          let act = `CSM/master/CSM_CustomerUpdateSW?customer_code=${cuscode}`
          let rsp = await $xt.getServer(act)
          this.$set(this, 'itupdateAuto', rsp.data||'N')
        },
        ...
        itemTypeChange() {
          ...
          this.$set(this.editDetailData, 'alert_type', noti.alert_type ?? 'B')
          this.$set(this.editDetailData, 'auto_complete', noti.auto_complete ?? 'N')
          this.$set(this.editDetailData, 'complete_days', noti.complete_days ?? 1)
        ...
        updateCommentTextExt(newValue) {
          this.$set(this, 'commentTextExt', newValue);
        ...
        updateCommentText(newValue) {
          this.$set(this, 'commentText', newValue);
          this.createComment();
        },
        ...
        updateAttachment(newValue) {
          this.$set(this, 'attachmentData', newValue);
        },
        // Loading
        loadingBox(status) {
        if (status == 'show') {
      ...
      openAddSpecModal() {
        ...
        async retrievePlanWhenAcceptJob() {
          ...
          let resp = await $xt.getServer(act)
          this.$set(this, 'list_ppn', resp.data.plan_auth)
        },
        ...
        async getApiPPN() {
          ...
          this.$set(this, 'listTask', rsp.data)
          this.$set(this.formData, 'job_status', 'I')
          await this.saveClick()
          await $xt.sleep(1000)
        ...
        async calProgress(key) {
          switch (key) {
            case "tester":
              ...
              this.$set(this.editDetailData, 't_progress', t_progress)
              let t_manhour0 = this.editDetailData.t_manhour;
              t_manhour0 = 30 + $xt.dec(t_manhour0, 2)
              this.$set(this.editDetailData, 't_manhour', t_manhour0);
              break;
            case "all":
              ...
              if (new_total > 100)
              {
                ...
                this.$set(this.editDetailData, 'n_progress', n_);
              }
              if (new_total < 0)
              {
                new_total = 0
                ...
                this.$set(this.editDetailData, 't_progress', new_total);
              // =------------------------------------------------------
              ...
              this.$set(this.editDetailData, 't_manhour', t_manhour);
              // this.$set(this.editDetailData, 'n_manhour', totalMinutes);
            ...
            case "reject":
              ...
              if (t_progress3 > 0) {
                ...
                this.$set(this.editDetailData, 't_progress', 100);
                this.$set(this.editDetailData, 'n_progress', pro);
              }
              else if (t_progress3 < 1) {
                this.$set(this.editDetailData, 't_progress', 0);
                this.$set(this.editDetailData, 'n_progress', 0);
              }
              break;
          }
        },
        ...
        copyWorkerTaskToAll() {
          ...
          this.detailChange.forEach((x, idx) => {
            if (idx === 0) return
            this.$set(x, 'assign_empno', first.assign_empno)
            this.$set(x, 'assign_empno_name', first.assign_empno_name)
          })
        },
        async runAiAnalysis(x) {
          this.$set(x, 'aiAnalysisLoading', true)
          try {
            ...
            this.$set(x, 'ai_analysis_result', rsp.data.ai_analysis_result)
            this.$set(x, 'ai_analysis_result_wk', rsp.data.ai_analysis_result_wk)
            if (rsp.data.difficulty_level) {
              this.$set(x, 'level_task', String(rsp.data.difficulty_level))
              this.$set(x, 'ai_difficulty_reason', rsp.data.difficulty_reason)
            }
            if (rsp.data.estimated_end_date) {
              this.$set(x, 'worker_end_date', new Date(rsp.data.estimated_end_date))
              this.$set(x, 'ai_estimated_days', rsp.data.estimated_days)
              this.validateWorkerDates(x)
            }
            this.$set(x, 'ai_approval_info', rsp.data.approval_info)
            this.$set(x, 'ai_token_usage_in', rsp.data.token_usage_in)
            this.$set(x, 'ai_token_usage_out', rsp.data.token_usage_out)
            this.openAiAnalysisModal(x)
          } finally {
            this.$set(x, 'aiAnalysisLoading', false)
          }
        },
      ...
      async mounted() {
        ...
        if (ref_draft_csm != null || ref_draft_csm != undefined) {
          ...
          this.$set(this.formData, 'pre_des', p.formData.pre_des)
