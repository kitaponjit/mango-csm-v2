...
export default {
  ...
  computed: {
    canUpload() {
      return (((this.editDetailData.tester_empno == this.auth.empno && (this.formData.job_status != 'Y' || this.editDetailData.status != 'Y') && !this.isView) || this.isSoftwareTester) || this.isAdmin) && this.editDetailData.status != 'W';
    },
  },
  methods: {
