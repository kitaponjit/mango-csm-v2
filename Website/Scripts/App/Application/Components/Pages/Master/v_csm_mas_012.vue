...
export default {
  ...
  methods: {
    ...
    pageChange(pn) {
      ...
      this.$set(this, "Display_Data", $linq(this.datalist).skip(paging.skipItems()).take(paging.getItemsPerPage()).toArray());
    ...
    pageChange_item(pn) {
      ...
      this.$set(this, "Display_Detail", $linq(this.itemData).skip(paging_item.skipItems()).take(paging_item.getItemsPerPage()).toArray());
    ...
    pageChange_modal(pn) {
      ...
      this.$set(this, "detail_paging", $linq(this.detail).skip(paging_modal.skipItems()).take(paging_modal.getItemsPerPage()).toArray());
