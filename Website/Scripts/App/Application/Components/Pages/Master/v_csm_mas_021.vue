      ...
      async sendComponent(e, type) {
        switch (type) {
          ...
          case "ct_project_unit_edit":
            this.$set(this.modalData, "pre_event", e.pre_event);
            this.$set(this.modalData, "pre_event_unit", e.pre_event);
            this.$set(this.modalData, "pre_event2", e.pre_event2);
            this.$set(this.modalData, "house_no", e.house_number);
            this.isEditMo = 'Y'
            break;
      ...
      pageChange(pn, pt) {
        switch (pt) {
          case 'pending':
            ...
            this.$set(this, "pendingDataDisplay", $linq(this.pendingData).skip(pagingPending.skipItems()).take(pagingPending.getItemsPerPage()).toArray());
            pagingPending.createPagesArray();
            this.$refs.agr.setDisplay(this.pendingDataDisplay);
          ...
          case 'complete':
            ...
            this.$set(this, "completedDataDisplay", $linq(this.completedData).skip(pagingComplete.skipItems()).take(pagingComplete.getItemsPerPage()).toArray());
            pagingComplete.createPagesArray();
            this.$refs.agr2.setDisplay(this.completedDataDisplay);
            break;
        }
