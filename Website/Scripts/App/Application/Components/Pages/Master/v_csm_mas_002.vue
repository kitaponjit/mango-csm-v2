...
let cpn = {
  ...
  methods: {
    ...
    defaultImportMaster() {
      this.$set(this, 'importFormMaster', {
        war_code: 'A', war_des: 'B', type_code: 'C', tot_date: 'D', tot_month: 'E', tot_year: 'F',
        lifetime: 'G', itemcode: 'H', vendor: 'J', war_date_start: 'K', war_date_end: 'L', active: 'M'
      })
    },
    ...
    selectItem() {
      this.$set(this, "selectedItems" , this.dataListIC.filter(x => x.cc_select == "Y"))
      this.$set(this, "selectAllChecked", this.dataListIC.every(x => x.cc_select == "Y") ? "Y" : "N")
      // this.pageChange(this.pageNumber)
    },
