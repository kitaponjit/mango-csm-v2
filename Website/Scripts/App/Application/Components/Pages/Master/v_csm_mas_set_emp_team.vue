    ...
    methods: {
      ...
      async setEdit(x) {
        try {
          ...
          this.$set(this, 'teamHead', rsp.data.head || {});
          this.$set(this, 'teamWorkers', rsp.data.work || []);
      ...
      async list_type_pg(req_code) {
        try {
          ...
          let rsp = await $xt.getServer(act);
          this.$set(this, "type_pg", rsp.data);
      ...
      async sendComponent(data, type) {
        if (type === 'emp' && this.editingLeader) {
          ...
          this.$set(this.teamHead, 'empno_h', data.empno);
          this.$set(this.teamHead, 'empfullname_t', data.empfullname || data.empfullname_t || '');
          this.$set(this.teamHead, 'posname_t', data.posname || data.posname_t || '');
          this.$set(this.teamHead, 'emppos', data.emppos || '');
          this.editingLeader = false;
          return;
        }
        if (type === 'emp' && this.selectedWorkerIdx !== null) {
          ...
          if (w) {
            this.$set(w, 'empno', data.empno);
            this.$set(w, 'empfullname_t', data.empfullname || data.empfullname_t || '');
            this.$set(w, 'posname_t', data.posname || data.posname_t || '');
            this.$set(w, 'emppos', data.emppos || '');
          }
          this.selectedWorkerIdx = null;
        }
      },
