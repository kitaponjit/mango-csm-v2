  ...
  let cpn = {
    ...
    methods: {
      ...
      async sendComponent(e, type) {
        switch (type) {
          case 'addsp':
            this.$set(this.form, 'remark', e.remark)
            this.$set(this.form, 'page_name', e.object_name)

            break
          case 'emp':
            this.$set(this.form, 'empno', e.empno)
            this.$set(this.form, 'empname_t', e.empfullname)
            this.$set(this.form, 'empcode', e.empcode)
            break
          case 'column':
            this.$set(this.form, 'column_name', e.column_name)
        
            this.closeModal()
            break
          case 'menucsm':
            this.$set(this.form, 'page_name', e.page_name)
            this.$set(this.form, 'remark', e.remark)
