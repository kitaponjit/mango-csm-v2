  ...
  let cpn = {
    ...
    methods: {
      resetData() {
        this.editMode = false
        this.form = {}
        this.$set(this.form, "priority_status", "1")
        this.$set(this.form, "active", "Y")
      ...
      newitem() {
        ...
        //   this.$set(this.form, "serv_group_code",this.serv_group[0].serv_code)
        // }
        this.resetData()
        this.$set(this.form, "noti_date", 0)
        this.$set(this.form, "addspec_request", "N")
   ...
   ['_action', 'Action', 'text', { width: 160, child:
        ...
        switch (type) {
          case "Approve":
            if (this.form.approve_st == "Y") {
              this.$set(this.form, 'send_test_bug', "N")
            }
            break
          case "Auto":
            if (this.form.auto_task == "Y") {
              ...
              // this.$set(this.form, 'preventive_st', this.form.preventive_st_tmp)
              this.$set(this.form, 'addspec_request', this.form.addspec_request)
              this.$set(this.form, 'auto_task', "N")
            }
            break
          default:
            this.$set(this.form, "complete_days", 1)
            this.$set(this.form, 'auto_task', "N")
            break
        }
      },
     ...
     is_mango() {
      ...
      sendComponent1(e) {
        ...
        this.$set(gf, 'empno', e.empno);
        this.$set(gf, 'empfullname', e.empfullname);
