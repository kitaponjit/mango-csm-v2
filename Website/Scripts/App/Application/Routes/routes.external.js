...
const externalRoutes = [
  ...
  },
  {
    ...
    component: () => import(`../Components/Pages/External/v_csm_external_detail`),
    meta: {
      customer: true,
      customer_auth: true,
    },
  },
  {
    ...
    component: () => import(`../Components/Pages/External/v_csm_settings`),
    meta: {
      customer: true,
      customer_auth: true,
    },
  ...
  },
  {
    ...
    component: () => import(`../Components/Pages/External/v_csm_request`),
    meta: {
      customer: true,
      customer_auth: true,
    },
  },
  {
    ...
    component: () => import(`../Components/Pages/External/v_csm_dataview`),
    meta: {
      customer: true,
      customer_auth: true,
    },
